...
const OpenProjectDetail = ({ project }: { project: Project | null }) => {
  ...
  // Retrieve subcontractor_id from localStorage
  const subcontractorId = localStorage.getItem("subcontractor_id");

  if (!subcontractorId) {
    return (
      <div className="container">
        <p>Subcontractor ID is not available. Please log in again.</p>
      </div>
    );
  }
  ...
  const initialValues: FormValues = {
    ...
    subcontractor_id: parseInt(subcontractorId),
    proposal: "",
    total_bid_amount: "",
    breakdown_of_costs: "",
    payment_terms: "",
                ...
                >
                  ...
                  >
                    {({ isSubmitting, setFieldValue }) => (
                      <Form>
                        <Field type="hidden" name="project_id" />
                        <Field type="hidden" name="subcontractor_id" />
                        {/* Two-column Grid */}
